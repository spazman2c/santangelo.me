          ...
          <div className="bg-gray-900 border border-gray-700 rounded-2xl p-12 text-center">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-8">
              ...
              <div className="flex items-center space-x-4">
                ...
                <a href="https://github.com/spazman2c" target="_blank" rel="noopener noreferrer" className="bg-black border border-gray-700 p-3 rounded-lg text-gray-400 hover:text-white hover:border-blue-500 transition-colors">
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
